...
import eleven from "../src_assets/eleven.jpg";
import lovedive from "../src_assets/lovedive.jpg";
import melonUrl from "../src_assets/melon.png";
import genieUrl from "../src_assets/ginie.png";
...
const Album = ({ albumIndex, vector }) => {
    ...
    const imgUrl = ["/public/img/eleven.jpg", "/public/img/lovedive.jpg"]
            ...
            {vector === 0 ? (
                <div {...animatedItemRight} className="album-left" id="album">
                    ...
                    <div className="album-box-left">
                        <img className="album-img" src={eleven} />
                        <div className="album-info-box-left">
                            <h3  {...animatedItem}>{albumInfo[albumIndex]}</h3>
                            <div className="a-container">
                                <a href={melon[albumIndex]}><img src={melonUrl}></img></a>
                                <a href={genie[albumIndex]}><img src={genieUrl}></img></a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                (
                    <div {...animatedItemLeft} className="album-right" id="album">
                        ...
                        <div className="album-box-right">
                            ...
                            <img className="album-img" src={lovedive} />
                        </div>
                    </div>
                )
            }
