...
const Member = ({ memberIndex }) => {
    ...
    const imgUrl = ["./img/yujin2.jpg", "./img/gaeul2.jpg", "./img/rei2.jpg", "./img/wonyoung2.jpg", "./img/liz2.jpg", "./img/leeseo2.jpg"]
            ...
            <div {...animatedItem} className="member-box">
                ...
                <div className="member-info-box">
                    <div className="member-title-box">
                        ...
                        {instagram[memberIndex] === "" ? null : <a href={instagram[memberIndex]}><img src="./img/instagram.png"></img></a>}
